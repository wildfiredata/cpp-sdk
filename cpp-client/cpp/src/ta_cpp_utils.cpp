...
namespace wildfiredata {
    ...
    bool wildfiredata::TAEnableLog::getEnableLog() {
...
//        ta_enable_log_mutex.unlock();
    ...
    void wildfiredata::TAEnableLog::setEnableLog(bool enableLog) {
...
//        ta_enable_log_mutex.unlock();
    ...
    TALogType wildfiredata::TAEnableLog::getTALogType() {
        return _logType;
    }

    void wildfiredata::TAEnableLog::setTALogType(TALogType type) {
        _logType = type;
    }
